document.addEventListener('DOMContentLoaded' , function() {
    const fahrenheitInput = document.getElementById('fromCelsius');
    const celsiusInput = document.getElementById('toFahrenheit');
    const kelvinInput = document.getElementById('tempResults');
